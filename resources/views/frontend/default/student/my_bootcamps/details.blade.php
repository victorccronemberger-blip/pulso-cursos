                ...
                <div class="eNtry-breadcum">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('my.bootcamps') }}">{{ get_phrase('My Bootcamps') }}</a></li>
                                    ...
                                    <div class="inner d-flex justify-content-between align-items-start">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <div class="d-flex gap-3 c-card">
                                                <a href="{{ route('my.bootcamp.invoice', ['id' => $bootcamp->id]) }}" class="text-center">
                                                    <i class="fas fa-file-invoice"></i> {{ get_phrase('Invoice') }}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="module-content-{{ $module->id }}"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <ul class="live-classes">
                                                    ...
                                                    <li>
                                                        <div class="class-details">
                                                            <p class="class-title">{{ $class->title }}</p>

                                                            <div class="d-flex gap-3">
                                                                <div class="class-status">
                                                                    @if ($class->status == 'live')
                                                                    <span class="badge bg-danger text-capitalize">{{ $class->status }}</span>
                                                                    @elseif($class->status == 'upcoming')
                                                                    <span class="badge bg-warning text-capitalize">{{ $class->status }}</span>
                                                                    @elseif($class->status == 'completed')
                                                                    <span class="badge bg-success text-capitalize">{{ $class->status }}</span>
                                                                    @endif
                                                                </div>
                                                        ...
                                                        <div class="class-details">
                                                            ...
                                                            <div class="d-flex gap-3">
                                                                <div class="class-status">
                                                                    ...
                                                                    <span class="badge bg-success text-capitalize">{{ get_phrase('Resource') }}</span>
                                                                    @elseif($resource->upload_type == 'record')
                                                                    <span class="badge bg-primary text-capitalize">{{ get_phrase('Record') }}</span>
                                                                    @endif
                                                                </div>
                                                                <small class="text-12 text-color fw-400">
                                                ...
                                                @if ($live_classes->count() < 1 && $resources->count() < 1)
                                                        ...
                                                        @else
                                                        <p class="module-details no-data">
                                                            {{ get_phrase('Module is not available.') }}
                                                        </p>
                                                        @endif
                                            </div>
                                        </div>
