...
@section('content')
    ...
    <section class="breadcum-area">
        <div class="container">
            ...
            <div class="col-md-8">
                <h1 class="bundle-details-title text-white mt-5">{{ $bundle->title }}</h1>
                <p class="bundle-details-description text-white mt-4">{{ \Illuminate\Support\Str::limit(strip_tags($bundle->bundle_details), 120) }}</p>
                ...
                <div class="d-flex align-items-center mt-4 gap-4">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="bundle-details user-name text-white mt-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="bundle-details course-count text-white ">
