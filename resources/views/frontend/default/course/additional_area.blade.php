 ...
 <div class="mt-5">
     @foreach ($customFields as $field)
         ...
         @if ($field->custom_type == 'image')
             <div class="mt-4">
                 <h2 class="g-title text-dark">{{ $customTitles['image'] ?? '' }}</h2>
                 <div class="row">
         ...
         @elseif($field->custom_type == 'slider')
             {{-- SLIDER SECTION --}}
             <div class="mt-4">
                 <h2 class="g-title text-dark">{{ $customTitles['slider'] ?? '' }}</h2>
                 <!-- Banners Slider -->
         ...
         @elseif($field->custom_type == 'text')
             {{-- TEXT SECTION --}}
             <div class="mt-4">
                 <h2 class="g-title text-dark">{{ $customTitles['text'] ?? '' }}</h2>
         ...
         @elseif($field->custom_type == 'video')
             <div class="mt-4">
                 <h2 class="g-title text-dark"> {{ $customTitles['video'] ?? '' }}</h2>
                 <div class="row">
         ...
         @elseif($field->custom_type == 'faq')
             <div class="mt-4">
                 <h2 class="g-title text-dark">{{ $customTitles['faq'] ?? '' }}</h2>
         ...
         @elseif($field->custom_type == 'gallery')
             <div class="mt-4">
                 <h2 class="g-title text-dark">{{ $customTitles['gallery'] ?? '' }}</h2>
                 <div class="row g-3">
