...
@push('title', $category_details['title'] ?? get_phrase('Free Courses'))
@push('meta')@endpush
@push('css')@endpush
@section('content')
    <!------------------- Breadcum Area Start  ------>
                    ...
                    <div class="eNtry-breadcum">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ $category_details['title'] ?? get_phrase('Free Courses') }}
                                </li>
                            </ol>
                        </nav>
                        ...
                        <div class="row row-gap-3">
                            <div class="col-auto col-md-4 col-lg-3">
                                <h3 class="g-title mt-4">{{ $category_details['title'] ?? get_phrase('Free Courses') }}</h3>
                            </div>
