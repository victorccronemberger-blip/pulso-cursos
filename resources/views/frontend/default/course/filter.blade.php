<div class="sidebar">
    <div class="row mb-4">
        ...
        <div class="col-6 text-end">
            ...
            <a class="btn d-flex align-items-center float-end border py-2" href="{{route('courses')}}"><i class="fi-rr-cross-circle text-dark me-2"></i> <span>{{get_phrase('Clear')}} @if(isset($_GET) && count($_GET) > 0)({{count($_GET)}})@endif</span></a>
            @endif
        </div>
    </div>
