            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="eNtry-breadcum">
                        ...
                        <h3 class="g-title mt-5">{{ get_phrase('Contact Us') }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center mt-25">
                <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                    <div class="ol-card p-4 card contact-card Ecard g-card c-card">
                        ...
                        <h4 class="g-title text-dark">{{ get_phrase('Our Address') }}</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                    <div class="ol-card p-4 card contact-card Ecard g-card c-card">
                        ...
                        <h4 class="g-title text-dark">{{ get_phrase('Contact Info') }}</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                    <div class="ol-card p-4 card contact-card Ecard g-card c-card">
                        ...
                        <h4 class="g-title text-dark">{{ get_phrase('Contact Email') }}</h4>
                    ...
                    <div class="contact-left">
                        ...
                        <form action="{{ route('contact.store') }}" method="post" class="global-form mt-25" id="global-form">@csrf
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') border border-danger @enderror" placeholder="Seu nome">
                            </div>
                            <div class="form-group">
                                <label for="email" class="form-label">{{ get_phrase('Email') }}</label>
                                <input type="email" name="email" class="form-control @error('email') border border-danger @enderror" placeholder="Seu e-mail">
                            </div>
                            <div class="form-group">
                                <label for="phone" class="form-label">{{ get_phrase('Phone') }}</label>
                                <input type="tel" name="phone" class="form-control @error('phone') border border-danger @enderror" placeholder="Seu telefone">
                            </div>
                            <div class="form-group">
                                <label for="address" class="form-label">{{ get_phrase('Address') }}</label>
                                <input type="text" name="address" class="form-control @error('address') border border-danger @enderror" placeholder="Seu endereço">
                            </div>
                            <div class="form-group">
                                <label for="message" class="form-label">{{ get_phrase('Message') }}</label>
                                <textarea name="message" cols="30" rows="10" class="form-control @error('message') border border-danger @enderror" placeholder="Sua mensagem aqui ..."></textarea>
                            </div>
