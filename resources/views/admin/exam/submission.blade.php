...
<div class="ol-card  ">
    <div class="ol-card-body   ">
        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
            ...
            <a href="{{ route('admin.exams') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
            ...
            <div class="ol-card-body p-3 mb-5">
                    ...
                    <div class="col-md-6 d-flex align-items-center gap-3">
                        ...
                        <div class="custom-dropdown dropdown-filter @if (!isset($_GET) || (isset($_GET) && count($_GET) == 0))  @endif">
                            ...
                            <ul class="dropdown-list w-250px">
                                <li>
                                    <form id="filter-dropdown" action="{{ route('admin.exam.submissions', $exam_id ?? request()->route('id')) }}" method="get">
                        ...
                        <a href="{{ route('admin.exam.submissions', $exam_id ?? request()->route('id')) }}" class="me-2" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle text-dark"></i></a>
                        @endif
                    </div>

                    <!-- Search Box -->
                    <div class="col-md-6 mt-3 mt-md-0">
                        <form action="{{ route('admin.exam.submissions', $exam_id ?? request()->route('id')) }}" method="get">
                ...
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        <td class="print-d-none">
                                            <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('admin.submission.details', $submission->id) }}">{{ get_phrase('View Details') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" onclick="confirmModal('{{ route('admin.submission.delete', $submission->id) }}')" href="javascript:void(0)">{{ get_phrase('Delete Submission') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                        ...
                        @else
                        @include('admin.no_data', ['message' => get_phrase('No submissions found for this exam.')])
                        @endif
                    </div>
                </div>
