...
<div class="sidebar-logo-area">
    <a href="#" class="sidebar-logos">
        <img class="sidebar-logo-lg" height="50px" src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="">
        <img class="sidebar-logo-sm" height="35px" src="{{ get_image(get_frontend_settings('favicon')) }}" alt="">
    </a>
...
<div class="sidebar-nav-area">
    <nav class="sidebar-nav">
        <ul class="px-14px pb-24px">
            ...
            @if (has_permission('admin.exams'))
            <li class="sidebar-first-li first-li-have-sub @if ($current_route == 'admin.exams' || $current_route == 'admin.exam.create' || $current_route == 'admin.exam.edit' || $current_route == 'admin.exam.submissions' || $current_route == 'admin.submission.details') active showMenu @endif">
                <a href="javascript:void(0);">
                    <span class="icon fi fi-rr-document"></span>
                    <div class="text">
                        <span>{{ get_phrase('Exam') }}</span>
                    </div>
                </a>
                <ul class="first-sub-menu">
                    <li class="first-sub-menu-title fs-14px mb-18px">{{ get_phrase('Exam') }}</li>
                    <li class="sidebar-second-li @if ($current_route == 'admin.exams' || $current_route == 'admin.exam.edit' || $current_route == 'admin.exam.submissions' || $current_route == 'admin.submission.details') active @endif">
                        <a href="{{ route('admin.exams') }}">{{ get_phrase('Manage Exams') }}</a>
                    </li>
                    <li class="sidebar-second-li @if ($current_route == 'admin.exam.create') active @endif">
                        <a href="{{ route('admin.exam.create') }}">{{ get_phrase('Add New Exam') }}</a>
                    </li>
                </ul>
            </li>
            @endif
            ...
            <a href="javascript:void(0);">
                <span class="icon fi fi-rr-users-alt"></span>
                <div class="text">
            ...
            @if(has_permission('admin.teams'))

            <li class="sidebar-first-li first-li-have-sub @if ($current_route == 'admin.teams' || $current_route == 'admin.team.create' || $current_route == 'admin.team.edit' || $current_route == 'admin.team.submissions' || $current_route == 'admin.submission.details') active showMenu @endif">
                <a href="javascript:void(0);">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li @if ($current_route == 'admin.teams' || $current_route == 'admin.team.edit' || $current_route == 'admin.team.submissions' || $current_route == 'admin.submission.details') active @endif">
                        <a href="{{ route('admin.teams') }}">{{ get_phrase('Manage Team Members') }}</a>
                    </li>
                    <li class="sidebar-second-li @if ($current_route == 'admin.team.create') active @endif">
                        <a href="{{ route('admin.team.create') }}">{{ get_phrase('Add New Team memeber') }}</a>
                    </li>
                </ul>
            </li>
           ...
           {{-- @if (has_permission('admin.newsletter'))
            ...
            <li class="sidebar-first-li {{ $current_route == 'admin.contacts' ? 'active' : '' }}">
                <a href="{{ route('admin.contacts') }}">
                    <span class="icon fi fi-rr-portrait"></span>
                    <div class="text">
