<form action="{{ route('admin.customer.support.ticket.update', ['id' => $ticket->id]) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="fpb-7 mb-3">
        ...
        <select class="form-control ol-form-control neu-select " name="category_id" id="select_category_id" required>
    ...
    <div class="fpb-7 mb-3">
        ...
        <select class="form-control ol-form-control neu-select " name="user_id" id="select_user_id" required>
    ...
    <div class="fpb-7 mb-3">
        ...
        <select class="form-control ol-form-control neu-select " name="status_id" id="select_status_id" required>
    ...
    <div class="fpb-7 mb-3">
        ...
        <select class="form-control ol-form-control neu-select " name="priority_id" id="select_priority_id" required>
