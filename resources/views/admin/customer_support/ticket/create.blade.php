            ...
            <div class="ol-card">
                ...
                <div class="ol-card-body p-20px mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="neu-select " name="category_id" id="select_category_id" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="neu-select " name="user_id" id="select_user_id" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="neu-select " name="status_id" id="select_status_id" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="neu-select " name="priority_id" id="select_priority_id" required>
