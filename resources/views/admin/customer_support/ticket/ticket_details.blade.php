            ...
            <div class="row">
                <div class="col-md-4 divider">
                    <div class="mx-4 my-4 macro-section">
                        ...
                        <div>
                            <select class="form-control px-14px ol-form-control neu-select " id="macroSelect">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="fpb-7 mb-3">
                                            ...
                                            <select class="form-control px-14px ol-form-control neu-select " data-toggle="select2" name="user_id" id="select_user_id" required>
                                        ...
                                        <div class="fpb7 mb-2">
                                            ...
                                            <select class="form-control px-14px ol-form-control neu-select " data-toggle="select2" name="status_id" required>
                                        ...
                                        <div class="fpb7 mb-2">
                                            ...
                                            <select class="form-control px-14px ol-form-control neu-select " data-toggle="select2" name="priority_id" required>
                                        ...
                                        <div class="fpb7 mb-2">
                                            ...
                                            <select class="form-control px-14px ol-form-control neu-select " data-toggle="select2" name="category_id" required>
