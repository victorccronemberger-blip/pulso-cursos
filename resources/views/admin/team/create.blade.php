...
@push('title', get_phrase('Create Team Member'))
            ...
            <div class="ol-card-body">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="title fs-16px">
                        ...
                        {{ get_phrase('Add New Team Member') }}
                    </h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="text" name="designation" class="form-control ol-form-control" required>
                            </div>
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <textarea name="bio" class="form-control ol-form-control" rows="5"></textarea>
                            </div>
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="number" name="sort_order" value="0" class="form-control ol-form-control">
                            </div>
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <div class="eRadios">
                                    <div class="form-check">
                                        <input type="radio" name="status" value="1" class="form-check-input eRadioSuccess" checked>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="url" name="linkedin_url" class="form-control ol-form-control">
                            </div>
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="url" name="facebook_url" class="form-control ol-form-control">
                            </div>
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="url" name="twitter_url" class="form-control ol-form-control">
                            </div>
