...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <textarea name="description" rows="5" class="form-control ol-form-control nEditor" id="description"></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control ol-form-control neu-select " name="category_id" id="category_id" required>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control ol-form-control neu-select " name="level" id="level" required>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control ol-form-control neu-select " name="language" id="language" required>
