...
<form class="ajaxFormSubmission" action="{{ route('admin.lesson.edit') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group mb-2">
        ...
        <select class="form-control ol-form-control neu-select" id="edit_section_select" name="section_id" required>
    ...
    <div class="form-group mb-2">
        ...
        <textarea name="summary" class="form-control nEditor">{{ $lessons->summary }}</textarea>
    </div>
...
<script>
    ...
    if (typeof NeuSelect !== 'undefined') {
        new NeuSelect('#edit_section_select');
    }
