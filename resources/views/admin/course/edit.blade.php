                ...
                <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                    <div class="ol-sidebar-tab">
                        <div class="d-flex flex-column">
                            ...
                            <a class="nav-link @if ($tab == 'feature') active @endif" href="{{ route('admin.course.edit', [$param, 'tab' => 'feature']) }}">
                                <span class="icon fi-rr-info"></span>
                                <span>{{ get_phrase('Feature') }}</span>
                            </a>
                    ...
                    <div class="tab-content w-100">
                        ...
                        @includeWhen($tab == 'feature', 'admin.course.feature')
