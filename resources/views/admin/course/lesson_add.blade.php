...
<form class="ajaxFormSubmission" action="{{ route('admin.lesson.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group mb-3">
        ...
        <select class="form-control ol-form-control neu-select" id="section_select" name="section_id" required>
    ...
    <div class="form-group mb-3">
        ...
        <textarea name="summary" class="form-control nEditor"></textarea>
    </div>
