    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="mb-3">
                ...
                <select class="ol-form-control neu-select" id="quiz_section_select" name="section_id" required>
            ...
            <div class="mb-3">
                <label for="drip_rule" class="form-label ol-form-label">
                    <span>{{ get_phrase('Drip content rule for quiz ') }}</span>
                    <small>{{ get_phrase('(This will only work if drip content is enabled)') }}</small>
                </label>
                <select class="ol-form-control neu-select" id="quiz_drip_select" name="drip_rule" required>
                    <option value="">{{ get_phrase('Select a section') }}</option>
            ...
            <div class="mb-3">
                ...
                <textarea name="summary" class="form-control ol-form-control" id="quiz_summary"></textarea>
            </div>
...
<script>
    ...
    if (typeof NeuSelect !== 'undefined') {
        ...
        new NeuSelect('#quiz_drip_select');
    }
