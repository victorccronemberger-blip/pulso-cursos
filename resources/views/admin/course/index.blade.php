...
<div class="row g-2 g-sm-3 row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 row-cols-xl-5">
    <div class="col">
        <a href="{{ route('admin.courses', ['status' => 'active']) }}" class="d-block text-decoration-none">
    ...
    <div class="col">
        <a href="{{ route('admin.courses', ['status' => 'pending']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body ">
                    <div style="display: flex; align-items: center; gap: 14px;">
    ...
    <div class="col">
        <a href="{{ route('admin.courses', ['status' => 'upcoming']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body ">
                    <div style="display: flex; align-items: center; gap: 14px;">
    ...
    <div class="col">
        <a href="{{ route('admin.courses', ['price' => 'free']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body ">
                    <div style="display: flex; align-items: center; gap: 14px;">
    ...
    <div class="col">
        <a href="{{ route('admin.courses', ['price' => 'paid']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body ">
                    <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div class="ol-card-body">
                <div class="row mt-3 mb-4">
                    <div class="col-md-6 d-flex align-items-center gap-3">
                                    ...
                                    <form id="filter-dropdown" action="{{ route('admin.courses') }}" method="get">
                                        <div class="filter-option d-flex flex-column gap-3">
                                            ...
                                            <div>
                                                ...
                                                <select class="form-control ol-form-control neu-select " data-toggle="select2" name="status" class="ol-select-2" data-placeholder="Type to search...">
                                            ...
                                            <div>
                                                ...
                                                <select class="form-control ol-form-control neu-select " data-toggle="select2" name="instructor" class="ol-select-2" data-placeholder="Type to search...">
                                                    <option value="all">{{ get_phrase('All') }}
                                                    </option>
                                            ...
                                            <div>
                                                ...
                                                <select class="form-control ol-form-control neu-select " data-toggle="select2" name="price" class="ol-select-2" data-placeholder="Type to search...">
                                                    <option value="all">{{ get_phrase('All') }}
                                                    </option>
                        ...
                        <a href="{{ route('admin.courses') }}" class="me-2" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle text-dark"></i></a>
                        @endif
                    </div>
                                                ...
                                                <div class="dAdmin_profile_name">
                                                    ...
                                                    <a href="{{ route('admin.courses', ['instructor' => $row->user_id]) }}">
                                                        <p class="sub-title2 text-12px">
                                                            ...
                                                            {{ get_user_info($row->user_id)->name }}
                                                        </p>
                                                        <p class="sub-title2 text-12px">{{ get_phrase('Email') }}:
                                                            {{ get_user_info($row->user_id)->email }}
                                                        </p>
                                                    </a>
                                                </div>
                                            </div>
