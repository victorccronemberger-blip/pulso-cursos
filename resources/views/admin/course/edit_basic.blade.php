...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="neu-select " name="instructors[]" id="instructor_id" multiple="multiple" data-placeholder="Choose ...">
            @php
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <textarea name="description" rows="5" class="form-control ol-form-control nEditor" id="description">{!! removeScripts($course_details->description) !!}</textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="neu-select " name="category_id" data-minimum-results-for-search="Infinity" required>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="neu-select " name="level" required>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="neu-select " name="language" required>
