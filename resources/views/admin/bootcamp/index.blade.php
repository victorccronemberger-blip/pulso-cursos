            ...
            <div class="ol-card-body ">
                <div class="row mb-4 mt-3">
                    <div class="col-md-6 d-flex align-items-center gap-3">
                        ...
                        <a href="{{ route('admin.bootcamps', ['type' => request()->route()->parameter('type')]) }}" class="me-2" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle text-dark"></i></a>
                        @endif
                    </div>
                                                ...
                                                <div class="dAdmin_profile_name">
                                                    ...
                                                    <a href="{{ route('admin.bootcamps', ['instructor' => $bootcamp->user_id]) }}">
                                                        <p class="sub-title2 text-12px">
                                                            ...
                                                            {{ get_user_info($bootcamp->user_id)->name }}
                                                        </p>
                                                        <p class="sub-title2 text-12px">
                                                            {{ get_phrase('Email') }}:
                                                            {{ get_user_info($bootcamp->user_id)->email }}
                                                        </p>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="sub-title2 text-12px">
                                                <a href="{{ route('admin.bootcamp.edit', [$bootcamp->id, 'tab' => 'curriculum']) }}">
                                                    <p>{{ get_phrase('Module') }}:
                                                        {{ count_bootcamp_modules($bootcamp->id) }}
                                                    </p>
                                                    <p> {{ get_phrase('Class') }}:
