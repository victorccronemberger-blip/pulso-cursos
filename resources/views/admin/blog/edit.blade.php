                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.blog.update', $blog_data->id) }}" method="post" enctype="multipart/form-data">@csrf
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="category_id" id="blog_category_id" required>
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <textarea name="description" class="form-control ol-form-control nEditor" id="summernote-basic">{!! removeScripts($blog_data->description) !!}</textarea>
                        </div>
