                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.blog.settings.update') }}" method="post" enctype="multipart/form-data">@csrf
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="instructors_blog_permission" required>
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="blog_visibility_on_the_home_page" required>
                                <option value="">{{ get_phrase('Select an option') }}</option>
