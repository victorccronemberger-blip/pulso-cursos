                    ...
                    <form action="{{ route('admin.course.bundle.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                @endphp
                                <select name="course_ids[]" id="select_bundle_courses" onchange="current_price_of_selected_courses(this)" class="neu-select-multi ol-form-control form-control" data-toggle="select2" multiple="multiple" required>
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <textarea name="bundle_details" class="form-control ol-form-control nEditor"></textarea>
                            </div>
                            <div class="pt-2">
