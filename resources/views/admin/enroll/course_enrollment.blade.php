                ...
                <div class="ol-card-body">
                    <form class="" action="{{ route('admin.student.post') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="neu-select-multi" name="user_id[]" multiple="multiple" required>
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select for='multiple_course_id' class="neu-select-multi  form-control" data-toggle="select2" multiple="multiple" name="course_id[]"
