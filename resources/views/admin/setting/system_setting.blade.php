                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="required-form" action="{{ route('admin.system.settings.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <select class="form-control ol-form-control neu-select " data-toggle="select2" name="language" id="language">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <select class="form-control ol-form-control neu-select " data-toggle="select2" name="student_email_verification" id="student_email_verification">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <select class="form-control ol-form-control neu-select " data-toggle="select2" id="timezone" name="timezone" required>
