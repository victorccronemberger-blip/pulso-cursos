                                ...
                                <div class="ol-card-body">
                                    <form action="{{ route('admin.payment.settings.update') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="fpb-7 mb-3">
                                            ...
                                            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="system_currency" required>
                                        ...
                                        <div class="fpb-7 mb-3">
                                            ...
                                            <select class="form-control ol-form-control neu-select " data-toggle="select2" id = "currency_position" name="currency_position" required>
                                    ...
                                    <div class="ol-card-body">
                                        <form action="{{ route('admin.payment.settings.update') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            @if ($payment_gateway->identifier != 'offline')
                                                <div class=" mb-3">
                                                    <label class="mb-2 ol-form-label ">{{ get_phrase('Active') }}</label>
                                                    <select class="form-control ol-form-control neu-select " data-toggle="select2" name="status">
                                                ...
                                                <div class=" mb-3">
                                                    <label class="mb-2 ol-form-label ">{{ get_phrase('Want to keep test mode enabled') }}?</label>
                                                    <select class="form-control ol-form-control neu-select " data-toggle="select2" name="test_mode">
                                                ...
                                                <div class=" mb-3">
                                                    <label class="mb-2 ol-form-label ">{{ get_phrase('Select currency') }}</label>
                                                    <select class="form-control ol-form-control neu-select " data-toggle="select2" name="currency" required>
                                                        <option value="">{{ get_phrase('Select currency') }}</option>
                                                ...
                                                @foreach (json_decode($payment_gateway['keys'], true) as $key => $value)
                                                    @if ($key == 'theme_color')
                                                        <label class="mb-2 ol-form-label ">{{ get_phrase(str_replace('_', ' ', $key)) }}</label>
                                            ...
                                            @else
                                                <div class=" mb-3 col-md-12">
                                                    <select name="status" id="status" class="form-control ol-form-control neu-select " data-toggle="select2">
                                                ...
                                                @foreach (json_decode($payment_gateway['keys'], true) as $key => $value)
                                                    <div class=" mb-3">
                                                        <label class="mb-2 ol-form-label ">{{ get_phrase(str_replace('_', ' ', $key)) }}</label>
                                                        <textarea name="{{ $key }}" rows="5" class="form-control ol-form-control nEditor" required>{{ $value }}</textarea>
                                                    </div>
                                                @endforeach
                                            @endif
