...
<form class="required-form" action="{{ route('admin.website.settings.update') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="fpb-7 mb-3">
        ...
        <input type="radio" class="form-check-input" value="youtube" name="promo_video_provider" id="youtube_promo_video" @if (get_frontend_settings('promo_video_provider') == 'youtube') checked @endif>&nbsp;<label class="form-label ol-form-label" for="youtube_promo_video">{{ get_phrase('Youtube Video Link') }}</label>

        &nbsp;&nbsp;
        <input type="radio" class="form-check-input" value="vimeo" name="promo_video_provider" id="vimeo_promo_video" @if (get_frontend_settings('promo_video_provider') == 'vimeo') checked @endif>&nbsp;<label class="form-label ol-form-label" for="vimeo_promo_video">{{ get_phrase('Vimeo Video Link') }}</label>

        &nbsp;&nbsp;
        <input type="radio" class="form-check-input" value="html5" name="promo_video_provider" id="html5_promo_video" @if (get_frontend_settings('promo_video_provider') == 'html5') checked @endif>&nbsp;<label class="form-label ol-form-label" for="html5_promo_video">{{ get_phrase('HTML5 Video link') }}</label>
    ...
    <div class="fpb-7 mb-3">
        ...
        <input type="radio" class="form-check-input" value="1" name="cookie_status" @if (get_frontend_settings('cookie_status') == 1) checked @endif>&nbsp;<label class="form-label ol-form-label" for="cookie_status_1">{{ get_phrase('Active') }}</label>

        &nbsp;&nbsp;
        <input type="radio" class="form-check-input" value="0" name="cookie_status" @if (get_frontend_settings('cookie_status') != 1) checked @endif>&nbsp;<label class="form-label ol-form-label" for="cookie_status_0">{{ get_phrase('Inactive') }}</label>
    ...
    <div class="fpb-7 mb-3">
        ...
        <textarea name="cookie_policy" id = "cookie_policy" class="form-control ol-form-control nEditor" rows="5">{!! removeScripts(get_frontend_settings('cookie_policy')) !!}</textarea>
    </div>
    <div class="fpb-7 mb-3">
        <label class="form-label ol-form-label" for="about_us">{{ get_phrase('About us') }}</label>
        <textarea name="about_us" id = "about_us" class="form-control ol-form-control nEditor" rows="5">{!! removeScripts(get_frontend_settings('about_us')) !!}</textarea>
    </div>
    <div class="fpb-7 mb-3">
        <label class="form-label ol-form-label" for="terms_and_condition">{{ get_phrase('Terms and condition') }}</label>
        <textarea name="terms_and_condition" id ="terms_and_condition" class="form-control ol-form-control nEditor" rows="5">{{ get_frontend_settings('terms_and_condition') }}</textarea>
    </div>
    <div class="fpb-7 mb-3">
        <label class="form-label ol-form-label" for="privacy_policy">{{ get_phrase('Privacy policy') }}</label>
        <textarea name="privacy_policy" id = "privacy_policy" class="form-control ol-form-control nEditor" rows="5">{{ get_frontend_settings('privacy_policy') }}</textarea>
    </div>

    <div class="fpb-7 mb-3">
        <label class="form-label ol-form-label" for="refund_policy">{{ get_phrase('Refund policy') }}</label>
        <textarea name="refund_policy" id = "refund_policy" class="form-control ol-form-control nEditor" rows="5">{{ get_frontend_settings('refund_policy') }}</textarea>
    </div>
