        ...
        <div class="ol-card card-hover">
            <div class="ol-card-body" style="display: flex; align-items: center; gap: 14px;">
                ...
                <div style="display: flex; flex-direction: column; justify-content: center; gap: 2px;">
                    <p class="title card-title-hover fs-18px" style="margin: 0;">{{App\Models\Course::count()}}</p>
    ...
    <div class="col">
        <div class="ol-card card-hover">
            <div class="ol-card-body" style="display: flex; align-items: center; gap: 14px;">
                ...
                <div style="display: flex; flex-direction: column; justify-content: center; gap: 2px;">
                    <p class="title card-title-hover fs-18px" style="margin: 0;">{{App\Models\Lesson::count()}}</p>
    ...
    <div class="col">
        <div class="ol-card card-hover">
            <div class="ol-card-body" style="display: flex; align-items: center; gap: 14px;">
                ...
                <div style="display: flex; flex-direction: column; justify-content: center; gap: 2px;">
                    <p class="title card-title-hover fs-18px" style="margin: 0;">{{App\Models\Enrollment::count()}}</p>
...
{{-- ══════════════════════════════════════
     REVENUE CHART — MODIFIED UI ONLY
══════════════════════════════════════ --}}
@php
            ...
            <div class="rev-header">
                ...
                <div class="rev-header-left">
                    ...
                    <div class="rev-header-text">
                        ...
                        <p class="rev-title">{{ get_phrase('Admin Revenue This Year') }}</p>
                    </div>
                </div>
                ...
                <div class="rev-header-right">
                    ...
                    {{-- Link --}}
                    <a class="rev-link-btn" href="{{ route('admin.revenue') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Admin Revenue') }}">
...
{{-- ══════════════════════════════════════
     PIE + PAYOUT (unchanged)
══════════════════════════════════════ --}}

{{-- Define $active etc. BEFORE they are used below --}}
@php
...
// Quarter slices (indices into allMonthlyData array which is 0-based after json_encode of 0–12)
const quarters = {
    all: { labels: monthLabels.slice(1),        data: allMonthlyData.slice(1) },
    q1:  { labels: monthLabels.slice(1, 4),     data: allMonthlyData.slice(1, 4) },
    q2:  { labels: monthLabels.slice(4, 7),     data: allMonthlyData.slice(4, 7) },
    q3:  { labels: monthLabels.slice(7, 10),    data: allMonthlyData.slice(7, 10) },
    q4:  { labels: monthLabels.slice(10, 13),   data: allMonthlyData.slice(10, 13) },
};
...
// ── Tab switcher — updates chart data only, no page reload ──
...
// ── Pie / Donut chart (unchanged logic) ──
