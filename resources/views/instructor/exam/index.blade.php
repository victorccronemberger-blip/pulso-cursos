...
<div class="ol-card">
    <div class="ol-card-body">
        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
            ...
            <a href="{{ route('instructor.exam.create') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
...
<div class="row g-2 g-sm-3 row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 row-cols-xl-4">
    ...
    <div class="col">
        <a href="{{ route('instructor.exams', ['status' => 'pending']) }}" class="d-block text-decoration-none">
    ...
    <div class="col">
        <a href="{{ route('instructor.exams', ['status' => 'checking']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body">
                    <div style="display: flex; align-items: center; gap: 14px;">
    ...
    <div class="col">
        <a href="{{ route('instructor.exams', ['status' => 'checked']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body">
                    <div style="display: flex; align-items: center; gap: 14px;">
    ...
    <div class="col">
        <a href="{{ route('instructor.exams', ['status' => 'published']) }}" class="d-block text-decoration-none">
            <div class="ol-card card-hover h-100">
                <div class="ol-card-body">
                    <div style="display: flex; align-items: center; gap: 14px;">
                    ...
                    <div class="col-md-6 d-flex align-items-center gap-3">
                        ...
                        <div class="custom-dropdown dropdown-filter">
                            ...
                            <ul class="dropdown-list w-250px">
                                <li>
                                    <form id="filter-dropdown" action="{{ route('instructor.exams') }}" method="get">
                        ...
                        <a href="{{ route('instructor.exams') }}" class="me-2" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}">
                            <i class="fi-rr-cross-circle text-dark"></i>
                        </a>
                        @endif
                    </div>

                    <div class="col-md-6 mt-3 mt-md-0">
                        <form action="{{ route('instructor.exams') }}" method="get">
                            ...
                            <table class="table eTable eTable-2 print-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{ ++$key }}</th>
                                        <td>
                                            <a href="{{ route('instructor.exam.submissions', $exam->id) }}" class="fw-bold text-decoration-none">
                                                {{ $exam->title }}
                                            </a>
                                            <br>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="description-link" data-description="{{ $exam->description }}">
                                        ...
                                        <td class="print-d-none">
                                            <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('instructor.exam.edit', [$exam->id, 'tab' => 'basic']) }}">
                                                            {{ get_phrase('Edit Exam') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" onclick="confirmModal('{{ route('instructor.exam.delete', $exam->id) }}')" href="javascript:void(0)">
                                                            {{ get_phrase('Delete Exam') }}
                                                        </a>
                                                    </li>

                                                    {{-- Publish button — only when all submissions are graded --}}
                                                    ...
                                                    @else
                                                    <li>
                                                        <form action="{{ route('instructor.exam.publish', $exam->id) }}" method="POST">
                                                            @csrf
    ...
    <div class="pdf-modal">
        <div class="pdf-modal-header">
            ...
            <div class="pdf-toolbar">
                <button class="pdf-zoom-btn" onclick="changeZoom(-0.2)" title="Zoom Out">&#8722;</button>
                <span class="pdf-zoom-label" id="pdfZoomLevel">100%</span>
                <button class="pdf-zoom-btn" onclick="changeZoom(0.2)" title="Zoom In">&#43;</button>
...
<script>
    ...
    document.querySelectorAll('.description-link').forEach(function(link) {
        link.addEventListener('click', function(e) {
            ...
            document.getElementById('descriptionContent').textContent = description.trim() !== '' ?
                description : '{{ get_phrase("No description available") }}';
    ...
    function changeZoom(delta) {
        zoomScale = Math.min(Math.max(zoomScale + delta, 0.4), 1.0);
