...
<form action="{{ route('instructor.bootcamp.live.class.update', $id) }}" method="post">@csrf
    ...
    <div class="row mb-3">
        <div class="col-sm-6 fpb-7">
            ...
            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="module_id">
    ...
    <div class="fpb-7 mb-3">
        ...
        <textarea name="description" rows="5" class="form-control ol-form-control nEditor">{!! $class->description !!}</textarea>
    </div>
