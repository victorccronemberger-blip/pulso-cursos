...
<li class="sidebar-first-li first-li-have-sub @if ($current_route == 'instructor.exams' || $current_route == 'instructor.exam.create' || $current_route == 'instructor.exam.edit' || $current_route == 'instructor.exam.submissions' || $current_route == 'instructor.submission.details') active showMenu @endif">
    <a href="javascript:void(0);">
    ...
    <ul class="first-sub-menu">
        ...
        <li class="sidebar-second-li @if ($current_route == 'instructor.exams' || $current_route == 'instructor.exam.edit' || $current_route == 'instructor.exam.submissions' || $current_route == 'instructor.submission.details') active @endif">
            <a href="{{ route('instructor.exams') }}">{{ get_phrase('Manage Exams') }}</a>
        </li>
        <li class="sidebar-second-li @if ($current_route == 'instructor.exam.create') active @endif">
            <a href="{{ route('instructor.exam.create') }}">{{ get_phrase('Add New Exam') }}</a>
        </li>
    </ul>
</li>
