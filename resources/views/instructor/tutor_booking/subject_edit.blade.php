    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="mb-3">
                ...
                <select class="form-control ol-form-control neu-select " name="subject_id" id="subject_id" required>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" placeholder="{{ get_phrase('Enter Description') }}" class="form-control ol-form-control nEditor" required>{{ $mySubDetails->description }}</textarea>
            </div>
