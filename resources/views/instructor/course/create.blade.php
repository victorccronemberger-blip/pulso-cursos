                        ...
                        <div class="col-md-6 pb-2">
                            <div class="eForm-layouts">
                                ...
                                <div class="fpb-7 mb-3">
                                    ...
                                    <textarea name="description" placeholder="{{ get_phrase('Enter Description') }}" class="form-control ol-form-control nEditor"></textarea>
                                </div>
                                <div class="fpb-7 mb-2">
                                    <label for="course_status" class="form-label ol-form-label">{{ get_phrase('Create as') }}
                        ...
                        <div class="col-md-6">
                            <div class="eForm-layouts">
                                <div class="fpb-7 mb-3">
                                    ...
                                    <select class="neu-select" name="category_id" id="category_id" required>
                                ...
                                <div class="fpb-7 mb-3">
                                    ...
                                    <select class="neu-select" name="level" id="level" required>
                                ...
                                <div class="fpb-7 mb-3">
                                    <label for="language" class="form-label ol-form-label">{{ get_phrase('Made in') }}
                                        <span class="text-danger ms-1">*</span></label>
                                    <select class="neu-select" name="language" id="language" required>
                                ...
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Pricing type') }}<span class="text-danger ms-1">*</span></label>
                                    <div class="eRadios">
                                        <div class="form-check">
                                ...
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Expiry period') }}</label>
                                    <div class="eRadios">
