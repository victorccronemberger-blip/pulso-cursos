<form class="required-form" action="{{ route('instructor.assignment.store', ['course_id' => $course_id]) }}" method="post"
    ...
    <div class="fpb-7 mb-3">
        <label class="form-label ol-form-label" for="questions">{{ get_phrase('Questions') }}<span
                class="required">*</span></label>
        <textarea name="questions" rows="5" class="form-control ol-form-control nEditor" id="questions"></textarea>
    </div>
