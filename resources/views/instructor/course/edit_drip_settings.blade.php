...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea id="locked_lesson_message" name="locked_lesson_message" placeholder="{{ get_phrase('Enter Description') }}" class="form-control ol-form-control nEditor">{!! $drip_content_settings['locked_lesson_message'] !!}</textarea>
    </div>
</div>