    ...
    <div class="offcanvas-body">
        <form class="aiAjaxFormSubmission" action="{{ route('instructor.open.ai.generate') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="neu-select " id="ai_service_selector" name="service_type" onchange="if(this.value == 'Course thumbnail'){$('#aiLanguageField').hide()}else{$('#aiLanguageField').show()}">
            ...
            <div class="mb-3" id="aiLanguageField">
                ...
                <select class="neu-select " name="language">
