            ...
            <div class="ol-card-body">
                <form action="{{ route('instructor.blog.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="fpb-7 mb-3">
                        ...
                        <select class="form-control ol-form-control neu-select" data-toggle="select2" name="category_id"
                    ...
                    <div class="fpb-7 mb-3">
                        ...
                        <input type="text" name="keywords" id="keywords" class="ol-form-control w-100" data-role="tagsinput">
                        <small class="text-muted">{{ get_phrase('Writing your keyword and hit enter button') }}</small>
                    </div>

                    <div class="fpb-7 mb-3">
                        <label class="form-label ol-form-label" for="summernote-basic">{{ get_phrase('Description') }}</label>
                        <textarea name="description" class="form-control ol-form-control nEditor"></textarea>
                    </div>
                    ...
                    <div class="fpb-7 mb-3">
                        ...
                        <div class="d-flex gap-4">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <label class="text-dark" for="mark_yes">{{ get_phrase('Yes') }}</label>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <input type="radio" id="mark_no" value="0" name="is_popular" checked>
                                <label class="text-dark" for="mark_no">{{ get_phrase('No') }}</label>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(function() {
        ...
        // Manually initialize Tagify on keywords input
