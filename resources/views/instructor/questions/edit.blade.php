...
<form class="ajaxForm" action="{{ route('instructor.course.question.update', $id) }}" method="post">@csrf
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mb-3">
                ...
                <select class="form-control ol-form-control neu-select " data-toggle="select2" name="type"
    ...
    <div class="fpb-7 mb-3">
        ...
        <textarea name="title" rows="5" class="form-control ol-form-control nEditor">{!! $question->title !!}</textarea>
    </div>
