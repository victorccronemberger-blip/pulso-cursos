...
<form action="{{ route('instructor.course.quiz.store') }}" method="post">@csrf
    <div class="row mb-3">
        <div class="col-sm-5 fpb-7">
            ...
            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="participant">
        ...
        <div class="col-sm-5 fpb-7">
            ...
            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="submission">
