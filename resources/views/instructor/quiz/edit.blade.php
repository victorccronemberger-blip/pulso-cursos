...
<form action="{{ route('instructor.course.quiz.update', $id) }}" method="post">@csrf
    ...
    <div class="row mb-3">
        <div class="col-sm-12 fpb-7">
            ...
            <select class="form-control ol-form-control neu-select " data-toggle="select2" name="section">
    ...
    <div class="fpb-7 mb-3">
        ...
        <textarea name="description" rows="5" class="form-control ol-form-control nEditor">{!! $quiz->description !!}</textarea>
    </div>
