...
@section('content')
    ...
    <div class="ol-card   print-d-none">
                    ...
                    <div class="row print-d-none row-gap-3  ">
                        <div class="col-md-6 d-flex align-items-center gap-3">
                            ...
                            @if (isset($_GET) && count($_GET) > 0)
                                <a href="{{ route('admin.offline.payments') }}" class="me-2" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><iclass="fi-rr-cross-circle text-dark"></iclass=></a>
                            @endif
                        </div>
