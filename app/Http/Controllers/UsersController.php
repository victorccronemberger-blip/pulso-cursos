...
class UsersController extends Controller
{
    ...
    public function admin_store(Request $request)
    {
        ...
        if ($done) {
            $admin_id = User::latest('id')->first();
            Permission::insert(['admin_id' => $admin_id->id, 'updated_at' => now(), 'created_at' => now()]);
        }
    ...
    public function admin_permission_store(Request $request)
    {
        ...
        if ($permission) {
            ...
            Permission::insert(['admin_id' => $user_id, 'permissions' => $set_per, 'updated_at' => now(), 'created_at' => now()]);
            return true;
        }
    }
    ...
    public function enroll_history(Request $request)
    {
        ...
        $enroll_history = Enrollment::with(['user', 'course']) 
