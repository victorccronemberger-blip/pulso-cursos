...
class BootcampController extends Controller
{
    ...
    public function index($type = '')
    {
        ...
        // admin দেখতে পাবে সব bootcamp, normal user শুধুমাত্র নিজের
        if (auth()->user()->role != 'admin') {
            $query = $query->where('bootcamps.user_id', auth()->user()->id);
        }
    ...
    public function edit($id)
    {
        ...
        if (auth()->user()->role != 'admin') {
            $bootcamp = $bootcamp->where('user_id', auth()->user()->id);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->tab == 'basic') {
            ...
            if (is_array($meta_keywords_arr)) {
                $meta_keywords = '';
                foreach ($meta_keywords_arr as $arr_val) {
