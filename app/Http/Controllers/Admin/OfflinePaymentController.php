    ...
    public function accept_payment($id)
    {
        ...
        if ($payment_details->item_type == 'course') {
            ...
            foreach($bootcamps as $bootcamp){
                ...
                $bootcamp_payment['updated_at'] = now();
                $bootcamp_payment['created_at'] = now();
            ...
            foreach($packages as $package){
                ...
                $package_payment['updated_at'] = now();
                $package_payment['created_at'] = now();
            ...
            foreach($schedules as $schedule){
                ...
                $schedule_payment['updated_at'] = now();
                $schedule_payment['created_at'] = now();
            ...
            foreach($ebooks as $ebook){
                ...
                $ebook_payment['updated_at'] = now();
                $ebook_payment['created_at'] = now();
                EbookPurchase::insert($ebook_payment);
                   ...
                   // insert bundle Payment and enroll user to courses in bundle
                        ...
                        foreach ($bundles as $bundle) {
                            ...
                            $bundle_payment['updated_at'] = now();
                            $bundle_payment['created_at'] = now();
