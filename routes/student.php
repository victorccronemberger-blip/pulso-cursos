...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(MyExamController::class)->group(function () {

        Route::get('my-exams', 'index')
            ->name('my.exams');

        Route::get('my-exams/{exam}/details', 'details')
            ->name('my.exam.details');

        Route::post('my-exams/{exam}/submit', 'submit')
            ->name('my.exam.submit');
    });
