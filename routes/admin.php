...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::controller(ExamController::class)->group(function () {
        ...
        Route::get('exam/delete/{id}', 'delete')->name('exam.delete');
        Route::get('exam/edit/{id}', 'edit')->name('exam.edit');
        Route::put('exam/update/{id}', 'update')->name('exam.update');
        Route::get('exam/submissions/{id}', 'submissions')->name('exam.submissions');

        // Submission routes
        Route::get('submission/{id}/details', 'submissionDetails')->name('submission.details');
        Route::get('submission/{id}/edit', 'editSubmission')->name('submission.edit');
        Route::get('submission/{id}/delete', 'deleteSubmission')->name('submission.delete');
        Route::patch('submission/{id}/update', 'updateSubmission')->name('submission.update');
        Route::post('submission/{id}/annotated-upload', 'uploadAnnotatedPdf')->name('submission.annotated.upload');

        Route::post('exam/{id}/publish', 'publishExam')->name('exam.publish');
    });
    ...
    Route::controller(TeamMemberController::class)->group(function () {
        Route::get('team', 'index')->name('teams');
        ...
        Route::get('team/status/{id}', 'changeStatus')->name('team.status');
    });
