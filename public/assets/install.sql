...
--
-- Host: localhost:8889
-- Generation Time: Mar 08, 2026 at 01:35 AM
...
CREATE TABLE `assignments` (
  ...
  `question_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `blog_comments` (
  ...
  `likes` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `bootcamp_live_classes` (
  ...
  `force_stop` int NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `builder_pages` (
  ...
  `is_permanent` int DEFAULT NULL,
  `status` int DEFAULT NULL,
  `edit_home_id` int DEFAULT NULL,
...
(23, 'Default', '[\"header\",\"hero_banner\",\"featured_courses\",\"webinar\",\"live_course_feature\",\"stats\",\"team\",\"support\",\"faq\",\"pricing\",\"testimonial\",\"cta\",\"footer\"]', NULL, NULL, 1, NULL, '2024-08-27 04:25:11', '2024-10-31 01:03:56');
...
CREATE TABLE `bundle_payments` (
  ...
  `payment_details` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `courses` (
  ...
  `is_paid` int DEFAULT NULL,
  `is_best` int NOT NULL DEFAULT '0',
  `price` double DEFAULT NULL,
  `discounted_price` double DEFAULT NULL,
  `discount_flag` int DEFAULT NULL,
  `enable_drip_content` int DEFAULT NULL,
  `drip_content_settings` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `outcomes` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `faqs` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `instructor_ids` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Table structure for table `course_approval_requests`
--

CREATE TABLE `course_approval_requests` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED DEFAULT NULL,
  `course_id` bigint UNSIGNED DEFAULT NULL,
...
CREATE TABLE `course_bundles` (
  `id` int NOT NULL,
  `user_id` int DEFAULT NULL,
  `course_ids` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `subscription_limit` int DEFAULT NULL,
  `thumbnail` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `price` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `bundle_details` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `enrollments` (
  ...
  `user_id` bigint UNSIGNED DEFAULT NULL,
  `course_id` bigint UNSIGNED DEFAULT NULL,
  `enrollment_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entry_date` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `expiry_date` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `exams` (
  ...
  `exam_mode` enum('online','offline') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'online',
  `question_paper_pdf` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `knowledge_base_topicks` (
  ...
  `topic_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `language_phrases` (
  ...
  `phrase` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `translated` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(812, 3, 'Start learning from the world\'s pro', 'Start learning from the world\'s pro', NULL, NULL),
(813, 3, 'instructors', 'instructors', NULL, NULL),
...
(815, 3, 'Fast Performance', 'Fast Performance', NULL, NULL),
(816, 3, 'It is a long established fact that a reader will be distracted.', 'It is a long established fact that a reader will be distracted.', NULL, NULL),
(817, 3, 'Perfect Responsive', 'Perfect Responsive', NULL, NULL),
(818, 3, 'Fast & Friendly Support', 'Fast & Friendly Support', NULL, NULL),
(819, 3, 'Easy to Use', 'Easy to Use', NULL, NULL),
(820, 3, 'Explore Top Courses Categories', 'Explore Top Courses Categories', NULL, NULL),
(821, 3, 'Featured Courses\n                        ', 'Featured Courses\n                        ', NULL, NULL),
(822, 3, 'View All Courses', 'View All Courses', NULL, NULL),
(823, 3, '150k  ', '150k  ', NULL, NULL),
(824, 3, 'Know About Us', 'Know About Us', NULL, NULL),
(825, 3, 'Learn & Grow Your Skills From', 'Learn & Grow Your Skills From', NULL, NULL),
(826, 3, 'Educate', 'Educate', NULL, NULL),
(827, 3, '\n                        It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.\n                    ', '\n                        It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.\n                    ', NULL, NULL),
(828, 3, 'Life time Access', 'Life time Access', NULL, NULL),
(829, 3, 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.\n                                ', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.\n                                ', NULL, NULL),
(830, 3, 'Learn from Anywhere', 'Learn from Anywhere', NULL, NULL),
(831, 3, 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', NULL, NULL),
(832, 3, 'More about us', 'More about us', NULL, NULL),
(833, 3, 'Testimonial', 'Testimonial', NULL, NULL),
(834, 3, 'What our clients says about us', 'What our clients says about us', NULL, NULL),
(835, 3, 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.', NULL, NULL),
(836, 3, 'Linchon Philips', 'Linchon Philips', NULL, NULL),
(837, 3, 'CEO @ Yahoo', 'CEO @ Yahoo', NULL, NULL),
(838, 3, 'Have a look on our news', 'Have a look on our news', NULL, NULL),
(839, 3, 'View All Blogs', 'View All Blogs', NULL, NULL),
(840, 3, 'Tickets', 'Tickets', NULL, NULL),
(841, 3, 'Add New Ticket', 'Add New Ticket', NULL, NULL),
(842, 3, 'Reports', 'Reports', NULL, NULL),
(843, 3, 'Ticket Macros', 'Ticket Macros', NULL, NULL),
(844, 3, 'Ticket Categories', 'Ticket Categories', NULL, NULL),
(845, 3, 'Ticket Priorities', 'Ticket Priorities', NULL, NULL),
(846, 3, 'Ticket Status', 'Ticket Status', NULL, NULL),
(847, 3, 'Manage SEO Settings', 'Manage SEO Settings', NULL, NULL),
(848, 3, 'Meta Title', 'Meta Title', NULL, NULL),
(849, 3, 'Meta Keywords', 'Meta Keywords', NULL, NULL),
(850, 3, 'Writing your keyword and hit the enter', 'Writing your keyword and hit the enter', NULL, NULL),
(851, 3, 'Meta Description', 'Meta Description', NULL, NULL),
(852, 3, 'Meta Robot', 'Meta Robot', NULL, NULL),
(853, 3, ' Canonical Url', ' Canonical Url', NULL, NULL),
(854, 3, ' Custom Url', ' Custom Url', NULL, NULL),
(855, 3, 'Og Title', 'Og Title', NULL, NULL),
(856, 3, 'Og Description', 'Og Description', NULL, NULL),
(857, 3, 'Og Image', 'Og Image', NULL, NULL),
(858, 3, 'Json Id', 'Json Id', NULL, NULL),
(859, 3, 'Course Bundle', 'Course Bundle', NULL, NULL),
(860, 3, 'Manage Bundle', 'Manage Bundle', NULL, NULL),
(861, 3, 'Add New Bundle', 'Add New Bundle', NULL, NULL),
(862, 3, 'Subscription Report', 'Subscription Report', NULL, NULL),
(863, 3, 'Enrollment', 'Enrollment', NULL, NULL),
(864, 3, 'Analytics', 'Analytics', NULL, NULL),
(865, 3, 'vs last month', 'vs last month', NULL, NULL),
(866, 3, 'Exam', 'Exam', NULL, NULL),
(867, 3, 'Manage Exams', 'Manage Exams', NULL, NULL),
(868, 3, 'Add New Exam', 'Add New Exam', NULL, NULL),
(869, 3, 'Teams', 'Teams', NULL, NULL),
(870, 3, 'Manage Team Members', 'Manage Team Members', NULL, NULL),
(871, 3, 'Add New Team memeber', 'Add New Team memeber', NULL, NULL),
(872, 3, 'কোর্সসমূহ', 'কোর্সসমূহ', NULL, NULL),
(873, 3, 'অন্যান্য', 'অন্যান্য', NULL, NULL),
(874, 3, 'কোর্স বান্ডেল', 'কোর্স বান্ডেল', NULL, NULL),
(875, 3, 'ফ্রি শিখুন', 'ফ্রি শিখুন', NULL, NULL),
(876, 3, 'আপনি কি শিখতে চান?', 'আপনি কি শিখতে চান?', NULL, NULL),
(877, 3, 'লগ-ইন', 'লগ-ইন', NULL, NULL),
(878, 3, 'খুঁজুন', 'খুঁজুন', NULL, NULL),
(879, 3, 'ভাষা', 'ভাষা', NULL, NULL),
(880, 3, 'বাংলা', 'বাংলা', NULL, NULL),
(881, 3, 'দেশের যেকোনো প্রান্ত থেকে বিশ্বমানের দক্ষতা অর্জন করুন এবং আপনার ক্যারিয়ারকে নতুন উচ্চতায় নিয়ে যান।', 'দেশের যেকোনো প্রান্ত থেকে বিশ্বমানের দক্ষতা অর্জন করুন এবং আপনার ক্যারিয়ারকে নতুন উচ্চতায় নিয়ে যান।', NULL, NULL),
(882, 3, 'আমাদের সোশ্যাল মিডিয়া', 'আমাদের সোশ্যাল মিডিয়া', NULL, NULL),
(883, 3, 'কোম্পানি', 'কোম্পানি', NULL, NULL),
(884, 3, 'সকল কোর্স', 'সকল কোর্স', NULL, NULL),
(885, 3, 'গোপনীয়তা নীতি', 'গোপনীয়তা নীতি', NULL, NULL),
(886, 3, 'রিফান্ড ও বাতিল নীতি', 'রিফান্ড ও বাতিল নীতি', NULL, NULL),
(887, 3, 'ব্যবহারের শর্তাবলি', 'ব্যবহারের শর্তাবলি', NULL, NULL),
(888, 3, 'ক্যারিয়ার ও যোগাযোগ', 'ক্যারিয়ার ও যোগাযোগ', NULL, NULL),
(889, 3, 'সহায়ক রিসোর্স', 'সহায়ক রিসোর্স', NULL, NULL),
(890, 3, 'আমাদের সম্পর্কে', 'আমাদের সম্পর্কে', NULL, NULL),
(891, 3, 'সাধারণ জিজ্ঞাসা', 'সাধারণ জিজ্ঞাসা', NULL, NULL),
(892, 3, 'যোগাযোগ করুন', 'যোগাযোগ করুন', NULL, NULL),
(893, 3, '© ২০২৪ সকল স্বত্ব সংরক্ষিত। Creativeitem কর্তৃক পরিচালিত।', '© ২০২৪ সকল স্বত্ব সংরক্ষিত। Creativeitem কর্তৃক পরিচালিত।', NULL, NULL),
(894, 3, '\n                        Your images ', '\n                        Your images ', NULL, NULL),
(895, 3, '\n                        Generated text ', '\n                        Generated text ', NULL, NULL),
(896, 3, '\n                        Copy ', '\n                        Copy ', NULL, NULL),
(897, 3, '\n            Copied ', '\n            Copied ', NULL, NULL),
(898, 3, 'ড্যাশবোর্ড', 'ড্যাশবোর্ড', NULL, NULL),
(899, 3, 'লগআউট', 'লগআউট', NULL, NULL),
(900, 3, 'ফ্রীতে ক্যারিয়ার গড়ুন', 'ফ্রীতে ক্যারিয়ার গড়ুন', NULL, NULL),
(901, 3, 'স্কিল ডেভেলপমেন্ট হবে সম্পূর্ণ ফ্রী', 'স্কিল ডেভেলপমেন্ট হবে সম্পূর্ণ ফ্রী', NULL, NULL),
(902, 3, 'সবগুলো দেখুন', 'সবগুলো দেখুন', NULL, NULL),
(903, 3, 'কি কি পাচ্ছেন আমাদের লাইভ কোর্সে', 'কি কি পাচ্ছেন আমাদের লাইভ কোর্সে', NULL, NULL),
(904, 3, 'দেখে নিন কি কি পাচ্ছেন ক্রিয়েটিভআইটেম একাডেমী কোর্স জয়েন করলে', 'দেখে নিন কি কি পাচ্ছেন ক্রিয়েটিভআইটেম একাডেমী কোর্স জয়েন করলে', NULL, NULL),
(905, 3, 'শিখুন ইন্ডাস্ট্রি এক্সপার্টদের থেকে লাইভে', 'শিখুন ইন্ডাস্ট্রি এক্সপার্টদের থেকে লাইভে', NULL, NULL),
(906, 3, 'কোর্স কমপ্লিট পাচ্ছেন জব প্রেসমেন্ট টিমের থেকে লাইফটাইম সিটি, প্রোফাইল বিল্ড এবং জব এপ্লিকেশনসহ ইন্টিগ্রেটেড জব প্রেসমেন্ট সাপোর্ট।', 'কোর্স কমপ্লিট পাচ্ছেন জব প্রেসমেন্ট টিমের থেকে লাইফটাইম সিটি, প্রোফাইল বিল্ড এবং জব এপ্লিকেশনসহ ইন্টিগ্রেটেড জব প্রেসমেন্ট সাপোর্ট।', NULL, NULL),
(907, 3, 'মডিউল ভিত্তিক স্টাডি প্ল্যান', 'মডিউল ভিত্তিক স্টাডি প্ল্যান', NULL, NULL),
(908, 3, 'কুইজ, এসাইনমেন্ট আর লাইভ এক্সামের মাধ্যমে সাজানো মডিউলভিত্তিক পাঠাবলির স্টাডিপ্ল্যানের সাথে চিটকে পড়ার কোনো দায়িত্ব নেই।', 'কুইজ, এসাইনমেন্ট আর লাইভ এক্সামের মাধ্যমে সাজানো মডিউলভিত্তিক পাঠাবলির স্টাডিপ্ল্যানের সাথে চিটকে পড়ার কোনো দায়িত্ব নেই।', NULL, NULL),
(909, 3, 'ইন্টিগ্রেটেড জব প্রেসমেন্ট সাপোর্ট', 'ইন্টিগ্রেটেড জব প্রেসমেন্ট সাপোর্ট', NULL, NULL),
(910, 3, 'রিয়েলটাইম প্রোগ্রেস ট্র্যাকিং', 'রিয়েলটাইম প্রোগ্রেস ট্র্যাকিং', NULL, NULL),
(911, 3, 'ট্র্যাক করুন আপনার প্রোগ্রেস রিয়েল টাইম, দেখে নিন লিডার বোর্ডে আপনার পজিশন আর কম্পিটিশনে এগিয়ে যান সবার থেকে।', 'ট্র্যাক করুন আপনার প্রোগ্রেস রিয়েল টাইম, দেখে নিন লিডার বোর্ডে আপনার পজিশন আর কম্পিটিশনে এগিয়ে যান সবার থেকে।', NULL, NULL),
(912, 3, 'বাংলাদেশের এক নম্বর অনলাইন শিক্ষা প্ল্যাটফর্ম', 'বাংলাদেশের এক নম্বর অনলাইন শিক্ষা প্ল্যাটফর্ম', NULL, NULL),
(913, 3, '০', '০', NULL, NULL),
(914, 3, 'সক্রিয় শিক্ষার্থী', 'সক্রিয় শিক্ষার্থী', NULL, NULL),
(915, 3, 'বিনামূল্যে ভিডিও লেসন', 'বিনামূল্যে ভিডিও লেসন', NULL, NULL),
(916, 3, 'প্রিমিয়াম কোর্স', 'প্রিমিয়াম কোর্স', NULL, NULL),
(917, 3, 'বছরের বিশ্বস্ত অভিজ্ঞতা', 'বছরের বিশ্বস্ত অভিজ্ঞতা', NULL, NULL),
(918, 3, 'আমাদের বিশেষজ্ঞ দল', 'আমাদের বিশেষজ্ঞ দল', NULL, NULL),
(919, 3, 'সকলকে দেখুন', 'সকলকে দেখুন', NULL, NULL),
(920, 3, 'যেকোনো সমস্যায় আমরা আছি আপনার পাশে', 'যেকোনো সমস্যায় আমরা আছি আপনার পাশে', NULL, NULL),
(921, 3, 'কোর্স সংক্রান্ত জিজ্ঞাসা, পেমেন্ট সহায়তা বা যেকোনো প্রযুক্তিগত সমস্যায় আমাদের সাপোর্ট টিম সর্বদা প্রস্তুত।', 'কোর্স সংক্রান্ত জিজ্ঞাসা, পেমেন্ট সহায়তা বা যেকোনো প্রযুক্তিগত সমস্যায় আমাদের সাপোর্ট টিম সর্বদা প্রস্তুত।', NULL, NULL),
(922, 3, '২৪/৭ সাপোর্ট', '২৪/৭ সাপোর্ট', NULL, NULL),
(923, 3, 'সাপোর্টে যোগাযোগ করুন', 'সাপোর্টে যোগাযোগ করুন', NULL, NULL),
(924, 3, 'ফ্রি ভিডিও দেখে দক্ষতা বাড়ান', 'ফ্রি ভিডিও দেখে দক্ষতা বাড়ান', NULL, NULL),
(925, 3, 'ভিডিও দেখুন', 'ভিডিও দেখুন', NULL, NULL),
(926, 3, 'আমাদের কমিউনিটিতে যোগ দিন', 'আমাদের কমিউনিটিতে যোগ দিন', NULL, NULL),
(927, 3, 'গ্রুপে যোগ দিন', 'গ্রুপে যোগ দিন', NULL, NULL),
(928, 3, 'How to create an account?', 'How to create an account?', NULL, NULL),
(929, 3, 'Interactively procrastinate high-payoff content without backward-compatible data. Quickly to cultivate optimal processes and tactical architectures. For The Completely iterate covalent strategic.', 'Interactively procrastinate high-payoff content without backward-compatible data. Quickly to cultivate optimal processes and tactical architectures. For The Completely iterate covalent strategic.', NULL, NULL),
(930, 3, 'Do you provide any support for this kit?', 'Do you provide any support for this kit?', NULL, NULL),
(931, 3, 'How long do you provide support?', 'How long do you provide support?', NULL, NULL),
(932, 3, 'আপনার সকল প্রশ্নের', 'আপনার সকল প্রশ্নের', NULL, NULL),
(933, 3, 'উত্তর এখানে', 'উত্তর এখানে', NULL, NULL),
(934, 3, 'দেখে নিন কি কি বাংলা রিগ্রুটিভঅ্যাজাইমোস প্রবাসীদের রেকর্ড জন্য করবো', 'দেখে নিন কি কি বাংলা রিগ্রুটিভঅ্যাজাইমোস প্রবাসীদের রেকর্ড জন্য করবো', NULL, NULL),
(935, 3, 'সাপোর্ট যোগাযোগ করুন', 'সাপোর্ট যোগাযোগ করুন', NULL, NULL),
(936, 3, 'বাংলাদেশের এক নম্বর শিক্ষা প্ল্যাটফর্ম', 'বাংলাদেশের এক নম্বর শিক্ষা প্ল্যাটফর্ম', NULL, NULL),
(937, 3, 'আজই শুরু করুন আপনার স্বপ্নের ক্যারিয়ার', 'আজই শুরু করুন আপনার স্বপ্নের ক্যারিয়ার', NULL, NULL),
(938, 3, 'বিনামূল্যে শুরু করুন', 'বিনামূল্যে শুরু করুন', NULL, NULL),
(939, 3, 'Exam Manager', 'Exam Manager', NULL, NULL),
(940, 3, 'Pending exams', 'Pending exams', NULL, NULL),
(941, 3, 'Checking exams', 'Checking exams', NULL, NULL),
(942, 3, 'Checked exams', 'Checked exams', NULL, NULL),
(943, 3, 'Published exams', 'Published exams', NULL, NULL),
(944, 3, 'Checking', 'Checking', NULL, NULL),
(945, 3, 'Checked', 'Checked', NULL, NULL),
(946, 3, 'Published', 'Published', NULL, NULL),
(947, 3, 'Question Paper', 'Question Paper', NULL, NULL),
(948, 3, 'No description available', 'No description available', NULL, NULL),
(949, 3, 'Create Exam', 'Create Exam', NULL, NULL),
(950, 3, 'Exam Title', 'Exam Title', NULL, NULL),
(951, 3, 'Enter Exam Title', 'Enter Exam Title', NULL, NULL),
(952, 3, 'Enter Exam Description', 'Enter Exam Description', NULL, NULL),
(953, 3, 'Marks', 'Marks', NULL, NULL),
(954, 3, 'Enter Total Marks', 'Enter Total Marks', NULL, NULL),
(955, 3, 'Duration (minutes)', 'Duration (minutes)', NULL, NULL),
(956, 3, 'Enter Exam Duration in Minutes', 'Enter Exam Duration in Minutes', NULL, NULL),
(957, 3, 'Select Course', 'Select Course', NULL, NULL),
(958, 3, 'Exam Mode', 'Exam Mode', NULL, NULL),
(959, 3, 'Online', 'Online', NULL, NULL),
(960, 3, 'Offline', 'Offline', NULL, NULL),
(961, 3, 'Upload Question PDF', 'Upload Question PDF', NULL, NULL),
(962, 3, 'Start Date & Time', 'Start Date & Time', NULL, NULL),
(963, 3, 'End Date & Time', 'End Date & Time', NULL, NULL),
(964, 3, 'Recaptcha', 'Recaptcha', NULL, NULL),
(965, 3, 'Media Management', 'Media Management', NULL, NULL),
(966, 3, 'Manage your media files here', 'Manage your media files here', NULL, NULL),
(967, 3, 'ব্যানার ইমেজ', 'ব্যানার ইমেজ', NULL, NULL),
(968, 3, 'হোমপেজ ব্যানার', 'হোমপেজ ব্যানার', NULL, NULL),
(969, 3, 'পরিবর্তন করুন', 'পরিবর্তন করুন', NULL, NULL),
(970, 3, 'সংরক্ষণ করুন', 'সংরক্ষণ করুন', NULL, NULL),
(971, 3, 'ব্যানার ভিডিও', 'ব্যানার ভিডিও', NULL, NULL),
(972, 3, 'হোমপেজ ব্যানার ভিডিও', 'হোমপেজ ব্যানার ভিডিও', NULL, NULL),
(973, 3, 'ব্যানার ভিডিও আপলোড করুন', 'ব্যানার ভিডিও আপলোড করুন', NULL, NULL),
(974, 3, 'লাইট লোগো', 'লাইট লোগো', NULL, NULL),
(975, 3, 'উজ্জ্বল পটভূমির জন্য', 'উজ্জ্বল পটভূমির জন্য', NULL, NULL),
(976, 3, 'ডার্ক লোগো', 'ডার্ক লোগো', NULL, NULL),
(977, 3, 'গাঢ় পটভূমির জন্য', 'গাঢ় পটভূমির জন্য', NULL, NULL),
(978, 3, 'ফেভিকন', 'ফেভিকন', NULL, NULL),
(979, 3, 'ব্রাউজার ট্যাব আইকন', 'ব্রাউজার ট্যাব আইকন', NULL, NULL),
(980, 3, 'store key', 'store key', NULL, NULL),
(981, 3, 'store password', 'store password', NULL, NULL),
(982, 3, 'store live key', 'store live key', NULL, NULL),
(983, 3, 'store live password', 'store live password', NULL, NULL),
(984, 3, 'sslcz testmode', 'sslcz testmode', NULL, NULL),
(985, 3, 'is localhost', 'is localhost', NULL, NULL),
(986, 3, 'sslcz live testmode', 'sslcz live testmode', NULL, NULL),
(987, 3, 'is live localhost', 'is live localhost', NULL, NULL),
(988, 3, 'store id', 'store id', NULL, NULL),
(989, 3, 'signature key', 'signature key', NULL, NULL),
(990, 3, 'store live id', 'store live id', NULL, NULL),
(991, 3, 'signature live key', 'signature live key', NULL, NULL),
(992, 3, 'merchant id', 'merchant id', NULL, NULL),
(993, 3, 'merchant password', 'merchant password', NULL, NULL),
(994, 3, 'merchant live id', 'merchant live id', NULL, NULL),
(995, 3, 'merchant live password', 'merchant live password', NULL, NULL),
(996, 3, 'Team Members', 'Team Members', NULL, NULL),
(997, 3, 'Team Members List', 'Team Members List', NULL, NULL),
(998, 3, 'Add New Member', 'Add New Member', NULL, NULL),
(999, 3, 'Member', 'Member', NULL, NULL),
(1000, 3, 'Sort Order', 'Sort Order', NULL, NULL),
(1001, 3, 'Mark email as verified', 'Mark email as verified', NULL, NULL),
(1002, 3, 'Remove account', 'Remove account', NULL, NULL),
(1003, 3, 'শিক্ষার্থীরা যা বলছেন', 'শিক্ষার্থীরা যা বলছেন', NULL, NULL),
(1004, 3, 'Coupon', 'Coupon', NULL, NULL),
(1005, 3, 'Add Coupon', 'Add Coupon', NULL, NULL),
(1006, 3, 'Search coupon', 'Search coupon', NULL, NULL),
(1007, 3, 'Manage Course Bundle', 'Manage Course Bundle', NULL, NULL),
(1008, 3, 'Search title or bundle owner', 'Search title or bundle owner', NULL, NULL),
(1009, 3, 'Course Bundle Admin Revenue', 'Course Bundle Admin Revenue', NULL, NULL),
(1010, 3, 'Course Bundle Instructor Revenue', 'Course Bundle Instructor Revenue', NULL, NULL),
(1011, 3, 'Approved', 'Approved', NULL, NULL),
(1012, 3, 'Suspended', 'Suspended', NULL, NULL),
(1013, 3, 'Admins', 'Admins', NULL, NULL),
(1014, 3, 'Admin List', 'Admin List', NULL, NULL),
(1015, 3, 'Root Admin', 'Root Admin', NULL, NULL),
(1016, 3, 'Create Admin', 'Create Admin', NULL, NULL),
(1017, 3, 'Admin Info', 'Admin Info', NULL, NULL),
(1018, 3, 'User deleted successfully', 'User deleted successfully', NULL, NULL),
(1019, 3, 'Team member deleted successfully.', 'Team member deleted successfully.', NULL, NULL),
(1020, 3, 'Private Message', 'Private Message', NULL, NULL),
(1021, 3, 'Chat List', 'Chat List', NULL, NULL),
(1022, 3, 'Create a new thread', 'Create a new thread', NULL, NULL),
(1023, 3, 'New message', 'New message', NULL, NULL),
(1024, 3, 'Invalid purchase code', 'Invalid purchase code', NULL, NULL),
(1025, 3, 'Facebook link', 'Facebook link', NULL, NULL),
(1026, 3, 'Twitter link', 'Twitter link', NULL, NULL),
(1027, 3, 'Linkedin link', 'Linkedin link', NULL, NULL),
(1028, 3, 'A short title about yourself', 'A short title about yourself', NULL, NULL),
(1029, 3, 'Skills', 'Skills', NULL, NULL),
(1030, 3, 'Write your skill and click the enter button', 'Write your skill and click the enter button', NULL, NULL),
(1031, 3, 'Photo', 'Photo', NULL, NULL),
(1032, 3, 'The image size should be any square image', 'The image size should be any square image', NULL, NULL),
(1033, 3, 'Update profile', 'Update profile', NULL, NULL),
(1034, 3, 'Current password', 'Current password', NULL, NULL),
(1035, 3, 'New password', 'New password', NULL, NULL),
(1036, 3, 'Confirm password', 'Confirm password', NULL, NULL),
(1037, 3, 'Update password', 'Update password', NULL, NULL),
(1038, 3, 'অজ্ঞাত', 'অজ্ঞাত', NULL, NULL),
(1039, 3, 'রেকর্ডেড ক্লাস', 'রেকর্ডেড ক্লাস', NULL, NULL),
(1040, 3, 'ইতিবাচক রিভিউ', 'ইতিবাচক রিভিউ', NULL, NULL),
(1041, 3, 'Expiry period', 'Expiry period', NULL, NULL),
(1042, 3, 'Lifetime', 'Lifetime', NULL, NULL),
(1043, 3, 'Limited time', 'Limited time', NULL, NULL),
(1044, 3, 'Number of month', 'Number of month', NULL, NULL),
(1045, 3, 'After purchase, students can access the course until your selected month.', 'After purchase, students can access the course until your selected month.', NULL, NULL),
(1046, 3, 'Enable drip content', 'Enable drip content', NULL, NULL),
(1047, 3, 'Off', 'Off', NULL, NULL),
(1048, 3, 'On', 'On', NULL, NULL),
(1049, 3, 'Feature', 'Feature', NULL, NULL),
(1050, 3, 'Assignment', 'Assignment', NULL, NULL),
(1051, 3, 'Drip Content', 'Drip Content', NULL, NULL),
(1052, 3, 'Custom Field', 'Custom Field', NULL, NULL),
(1053, 3, 'Notice Board', 'Notice Board', NULL, NULL),
(1054, 3, 'Scorm Content', 'Scorm Content', NULL, NULL),
(1055, 3, 'Amazon S3 Bucket', 'Amazon S3 Bucket', NULL, NULL),
(1056, 3, 'Video', 'Video', NULL, NULL),
(1057, 3, 'Invalid url', 'Invalid url', NULL, NULL),
(1058, 3, 'Your video source has to be either YouTube', 'Your video source has to be either YouTube', NULL, NULL),
(1059, 3, 'Analyzing', 'Analyzing', NULL, NULL),
(1060, 3, 'বিস্তারিত দেখি', 'বিস্তারিত দেখি', NULL, NULL),
(1061, 3, 'এখনই কিনুন', 'এখনই কিনুন', NULL, NULL),
(1062, 3, 'Category deleted successfully', 'Category deleted successfully', NULL, NULL),
(1063, 3, 'Course deleted successfully', 'Course deleted successfully', NULL, NULL);
...
CREATE TABLE `lessons` (
  ...
  `lesson_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duration` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_mark` int DEFAULT NULL,
  `pass_mark` int DEFAULT NULL,
  `retake` int DEFAULT NULL,
  `lesson_src` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `video_type` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `thumbnail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `live_classes` (
  ...
  `user_id` bigint UNSIGNED DEFAULT NULL,
  `course_id` bigint UNSIGNED DEFAULT NULL,
  `class_topic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `message_threads` (
  ...
  `contact_one` int DEFAULT NULL,
  `contact_two` int DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `payment_gateways` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `keys` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` int DEFAULT NULL,
...
CREATE TABLE `quiz_submissions` (
  ...
  `quiz_id` int DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `correct_answer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `wrong_answer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `submits` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `seo_fields` (`id`, `course_id`, `blog_id`, `bundle_id`, `bootcamp_id`, `route`, `name_route`, `meta_title`, `meta_keywords`, `meta_description`, `meta_robot`, `canonical_url`, `custom_url`, `json_ld`, `og_title`, `og_description`, `og_image`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, NULL, NULL, 'Home', 'home', 'Academy LMS Laravel', NULL, 'Home page for academy Seo', 'xxxxxx', 'https://academy.com', 'https://academy.com', '<script type=\"application/ld+json\"> {   \"@context\": \"http://schema.org\",   \"@type\": \"WebSite\",   \"name\": \"CodeCanyon\",   \"url\": \"https://codecanyon.net\" } </script>', 'ooooooooo', 'zzzzzzzzzz', 'OG-home.jpg', NULL, NULL),
(2, NULL, NULL, NULL, NULL, 'Compare', 'compare', 'Course compare', '[{\"value\":\"course\"},{\"value\":\"compare\"},{\"value\":\"difference\"}]', 'Course compare', 'xxxxxx', 'https:://academy.com/course-compare', 'https:://academy.com/course-compare', NULL, 'Course compare', 'Course compare', '2-customer-php-version.PNG', NULL, NULL),
(3, NULL, NULL, NULL, NULL, 'Privacy', 'privacy.policy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OG-documantation.jpg', NULL, NULL),
(4, NULL, NULL, NULL, NULL, 'Refund', 'refund.policy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OG-Blog.jpg', NULL, NULL),
(5, NULL, NULL, NULL, NULL, 'Terms- condition', 'terms.condition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OG-service.jpg', NULL, NULL),
(6, NULL, NULL, NULL, NULL, 'Faq', 'faq', 'Creative elements - ui subscription system', '[{\"value\":\"ui kits\"},{\"value\":\"website template\"},{\"value\":\"video template\"}]', 'Best and affordable ui kit subscription system', NULL, NULL, NULL, NULL, NULL, NULL, 'OG-elements home.jpg', NULL, NULL),
(7, NULL, NULL, NULL, NULL, 'Cookie policy', 'cookie.policy', 'Academy LMS - Cookie policy', '[{\"value\":\"ui kits\"},{\"value\":\"website template\"},{\"value\":\"video template\"}]', 'NULL', NULL, NULL, NULL, NULL, NULL, NULL, 'OG-elements home.jpg', NULL, NULL);
...
(2, 'system_name', 'BIMBanglades71', '2023-10-29 05:36:40', '2024-09-24 05:51:14'),
...
(16, 'system_currency', 'BDT', '2023-10-29 05:36:40', '2026-03-08 00:38:41'),
...
(20, 'currency_position', 'right-space', '2023-10-29 05:36:40', '2026-03-08 00:38:41'),
...
(30, 'version', '1.10', '2023-10-29 05:36:40', '2023-10-29 05:36:40'),
...
CREATE TABLE `submissions` (
  ...
  `submitted_pdf` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `annotation_data` json DEFAULT NULL,
  `annotated_pdf` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `obtained_marks` int DEFAULT NULL,
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` enum('pending','checking','checked','published') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `team_package_members` (
  ...
  `team_package_id` int DEFAULT NULL,
...
CREATE TABLE `ticket_messages` (
  `id` int NOT NULL,
  `ticket_thread_code` int DEFAULT NULL,
...
CREATE TABLE `tutor_bookings` (
  ...
  `joining_data` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `price` double DEFAULT NULL,
  `admin_revenue` double DEFAULT NULL,
  `instructor_revenue` double DEFAULT NULL,
  `tax` double DEFAULT NULL,
...
CREATE TABLE `tutor_reviews` (
  ...
  `student_id` int DEFAULT NULL,
  `rating` int DEFAULT NULL,
  `review` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `educations` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paymentkeys` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Table structure for table `watche_durations`
--

CREATE TABLE `watche_durations` (
  `id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `watche_histories`
--

CREATE TABLE `watche_histories` (
  `id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `watch_durations` (
  ...
  `watched_counter` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `watch_histories` (
  ...
  `course_id` int DEFAULT NULL,
  `student_id` int DEFAULT NULL,
  `completed_lesson` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `watching_lesson_id` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `course_progress` int DEFAULT NULL,
  `completed_date` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `wishlists` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` int DEFAULT NULL,
  `course_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `course_approval_requests`
--
ALTER TABLE `course_approval_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `course_approval_requests_user_id_index` (`user_id`),
  ADD KEY `course_approval_requests_course_id_index` (`course_id`);
...
ALTER TABLE `submissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `submissions_exam_id_student_id_unique` (`exam_id`,`student_id`),
...
--
-- Indexes for table `watche_durations`
--
ALTER TABLE `watche_durations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `watche_histories`
--
ALTER TABLE `watche_histories`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `course_approval_requests`
--
ALTER TABLE `course_approval_requests`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `language_phrases`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1064;
...
--
-- AUTO_INCREMENT for table `watche_durations`
--
ALTER TABLE `watche_durations`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `watche_histories`
--
ALTER TABLE `watche_histories`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `submissions`
  ADD CONSTRAINT `submissions_exam_id_foreign` FOREIGN KEY (`exam_id`) REFERENCES `exams` (`id`) ON DELETE CASCADE,
